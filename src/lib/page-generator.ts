...
function getTheme(themeId?: string): Theme {
  return DEFAULT_THEMES[themeId || 'neon-pink'] || DEFAULT_THEMES['neon-pink']
}

export function generatePublicPageHTML(pagina: PageData): string {
  const theme = getTheme(pagina.tema)
    ...
    * {
    ...
    .bg-gradient {
      ...
      background: linear-gradient(135deg, 
        ${theme.colors.primary}30 0%, 
        ${theme.colors.secondary}20 50%, 
        ${theme.colors.tertiary}30 100%);
    ...
    .bg-mesh {
      ...
      inset: 0;
      background: 
        radial-gradient(at 20% 30%, ${theme.colors.primary}15 0px, transparent 50%),
        radial-gradient(at 80% 70%, ${theme.colors.secondary}15 0px, transparent 50%),
        radial-gradient(at 50% 50%, ${theme.colors.tertiary}10 0px, transparent 50%);
      z-index: 2;
    }
...
<body>
  ...
  <div class="container">
    ...
    <div class="actions">
      ...
      <a href="${pagina.googleReviewLink}" target="_blank" onclick="registrarClique('google')" class="btn btn-google">
        <div class="btn-icon">
        ...
        <div class="btn-content">
          <div class="btn-title">Avaliar no Google</div>
          <div class="btn-description">Compartilhe sua experiência</div>
        </div>
      ...
      ${pagina.instagram ? `
      <a href="${instagramUrl}" target="_blank" onclick="registrarClique('instagram')" class="btn btn-instagram">
        <div class="btn-icon">
        ...
        <div class="btn-content">
          ...
          <div class="btn-description">Siga para novidades</div>
        </div>
        <div class="btn-shine"></div>
      </a>
      ` : ''}
      ...
      ${pagina.whatsapp ? `
      <a href="${whatsappUrl}" target="_blank" onclick="registrarClique('whatsapp')" class="btn btn-whatsapp">
        <div class="btn-icon">
        ...
        <div class="btn-content">
          ...
          <div class="btn-description">Entre em contato</div>
        </div>
        <div class="btn-shine"></div>
      </a>
      ` : ''}
